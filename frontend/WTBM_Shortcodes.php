...
//                add_shortcode( 'wtbm_get_movies_by_theater', array( $this, 'get_movies_by_theater' ) ); pending
            ...
            function get_movies_by_theater( $attr ) {
                ...
                $theater_id = isset( $attr['theater_id'] ) ? $attr['theater_id'] : '';
                $show_header = isset( $attr['show_header'] ) ? $attr['show_header'] : '';
                $template = '';
                if( $theater_id ){
                    $template = $this->display_registration_data_theater( $theater_id );
                }
            ...
            public function display_registration_data_theater( $theater_id ){
