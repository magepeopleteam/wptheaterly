...
if ( ! class_exists( 'MPWEM_Woo_Installer' ) ) {
	...
	class MPWEM_Woo_Installer {
		...
		public function handle_activation_redirect() {
			if ( ! get_transient( 'wtbm_plugin_activated' ) ) {
				return;
			}

			// Don't redirect on multi-site bulk activations
			if ( is_network_admin() || isset( $_GET['activate-multi'] ) ) {
				delete_transient( 'wtbm_plugin_activated' );
				return;
			}
		...
		public function enqueue_assets() {
			...
			wp_enqueue_style(
				'mpwem-woo-installer',
				WTBM_PLUGIN_URL . '/assets/admin/mpwem_woo_installer.css',
				array(),
				filemtime( WTBM_PLUGIN_DIR . '/assets/admin/mpwem_woo_installer.css' )
			);

			wp_enqueue_script(
				'mpwem-woo-installer',
				WTBM_PLUGIN_URL . '/assets/admin/mpwem_woo_installer.js',
				array( 'jquery' ),
				filemtime( WTBM_PLUGIN_DIR . '/assets/admin/mpwem_woo_installer.js' ),
				true
			);
			...
			wp_localize_script( 'mpwem-woo-installer', 'mpwem_woo_installer', array(
				...
				'i18n'             => array(
					'installing'     => __( 'Installing WooCommerce...', 'wptheaterly' ),
					'activating'     => __( 'Activating WooCommerce...', 'wptheaterly' ),
					'success'        => __( 'WooCommerce activated successfully!', 'wptheaterly' ),
					'redirecting'    => __( 'Redirecting...', 'wptheaterly' ),
					'error'          => __( 'Something went wrong. Please try again.', 'wptheaterly' ),
					'install_error'  => __( 'Installation failed. Please install WooCommerce manually.', 'wptheaterly' ),
			...
			<div id="mpwem-woo-overlay" class="mpwem-woo-overlay">
				<div class="mpwem-woo-popup">
					...
					<div class="mpwem-woo-header">
						...
						<span class="mpwem-woo-header-text"><?php esc_html_e( 'WP Theaterly', 'wptheaterly' ); ?></span>
					</div>
					...
					<div class="mpwem-woo-content">
						<h2 class="mpwem-woo-title"><?php esc_html_e( 'WooCommerce Required', 'wptheaterly' ); ?></h2>
						<p class="mpwem-woo-desc">
							<?php esc_html_e( 'WP Theaterly requires WooCommerce to manage cinema registrations, tickets, and payments. Please install and activate WooCommerce to continue using this plugin.', 'wptheaterly' ); ?>
						</p>
					</div>
					...
					<div class="mpwem-woo-features">
						<div class="mpwem-woo-feature">
							...
							<span><?php esc_html_e( 'Ticket selling & payments', 'wptheaterly' ); ?></span>
						</div>
						<div class="mpwem-woo-feature">
							<span class="mpwem-woo-feature-icon">
								<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M13.3 4.3L6 11.6 2.7 8.3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
							</span>
							<span><?php esc_html_e( 'Order management', 'wptheaterly' ); ?></span>
						</div>
						<div class="mpwem-woo-feature">
							<span class="mpwem-woo-feature-icon">
								<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M13.3 4.3L6 11.6 2.7 8.3" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
							</span>
							<span><?php esc_html_e( 'Attendee registration', 'wptheaterly' ); ?></span>
						</div>
					</div>
					...
					<div class="mpwem-woo-actions">
						...
						<a href="<?php echo esc_url( admin_url( 'plugin-install.php?s=woocommerce&tab=search&type=term' ) ); ?>" class="mpwem-woo-btn mpwem-woo-btn-secondary">
							<?php esc_html_e( 'Install Manually', 'wptheaterly' ); ?>
						</a>
					</div>
					...
					<p class="mpwem-woo-footer-note">
						...
						<?php esc_html_e( 'WooCommerce is free, open-source, and trusted by millions of stores worldwide.', 'wptheaterly' ); ?>
					</p>
				</div>
			</div>
			<?php
		...
		public function ajax_install_woocommerce() {
			...
			wp_send_json_success( array( 'message' => __( 'WooCommerce installed successfully.', 'wptheaterly' ) ) );
		}
		...
		public function ajax_activate_woocommerce() {
			...
			wp_send_json_success( array( 'message' => __( 'WooCommerce activated successfully!', 'wptheaterly' ) ) );
		}
	}
